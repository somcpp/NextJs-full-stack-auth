...
// 1. Move the form logic into its own inner client component
function ResetPasswordForm() {
  const searchParams = useSearchParams();
  const router = useRouter();
  
  // Now safely wrapped inside a Suspense loop during build time
...
// 2. The main page component acts as the layout wrapper and sets the Suspense Boundary
